...
.title{color: #42b983;cursor: pointer;margin-bottom: 35px;}\
\
#score{font-size: 22px;color: #999;}\
...
#tips p{color: #fff;}\
#tips p span{color:#f00;font-size: 30px;}';
...
do{
	css = css.replace(/[\s|\n]+/g, '');
	css = css.replace(reg,  RegExp.$1/100 ? RegExp.$1/100+'rem' : 0);
	var a = RegExp.$1;
	console.log(a);
}while(reg.test(css))
console.log(css);
